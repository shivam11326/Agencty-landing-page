  ...
  return (
    <section className="relative pt-32 lg:pt-36">
      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
          ...
          <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
            <div className="flex sm:flex-row flex-col gap-5 w-full">
              ...
              >
                ...
                <input
                  type="email"
                  placeholder="Shivam112603@gmail.com"
        ...
        <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:mx-0 mx-auto w-full h-full min-h-[500px]">
          <Spline
            scene="https://prod.spline.design/Jlt2lc6Alz2tf9ks/scene.splinecode"
